...
public class MemberReadService {
    ...
    public boolean checkPasswordIsIdentical(Long memberId, OriginalPasswordRequest request) {
        Password savedPassword = memberRepository.findPasswordById(memberId)
