...
public class EmailConfig {
    ...
    public JavaMailSender javaMailSender() {
        ...
        mailProperties.put("mail.smtp.auth", "true"); // smtp 서버에 이메일을 보낼 때 인증 필요. 무단 액세스로부터 계정 보호
        mailProperties.put("mail.smtp.starttls.enable", "true"); // tls 관련 설정. 메일 클라이언트와 서버 사이 연결 암호화. 데이터 안전 전송
        mailProperties.put("mail.smtp.debug", "false"); // 디버깅 가능
        mailProperties.put("mail.smtp.ssl.trust", "smtp.gmail.com"); // ssl 인증서 유효함을 인증
